...
if("TRUE" STREQUAL "TRUE")
  set(fish_msgs_SOURCE_PREFIX /home/fish/softroboticfish6/fish/pi/ros/catkin_ws/src/fish_msgs)
  set(fish_msgs_DEVEL_PREFIX /home/fish/softroboticfish6/fish/pi/ros/catkin_ws/devel)
  ...
  set(fish_msgs_INSTALL_PREFIX /home/fish/softroboticfish6/fish/pi/ros/catkin_ws/install)
...
if(NOT "/home/fish/softroboticfish6/fish/pi/ros/catkin_ws/devel/include " STREQUAL " ")
  set(fish_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/fish/softroboticfish6/fish/pi/ros/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'fish_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fish/softroboticfish6/fish/pi/ros/catkin_ws/src/fish_msgs/${idir}'.  Ask the maintainer 'Cyndia Cao <cyndiac@mit.edu>' to fix it.")
    endif()
...
set(fish_msgs_EXPORTED_TARGETS "fish_msgs_generate_messages_cpp;fish_msgs_generate_messages_eus;fish_msgs_generate_messages_lisp;fish_msgs_generate_messages_nodejs;fish_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${fish_msgs_dep}_FOUND)
      find_package(${fish_msgs_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${fish_msgs_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
