...
if("TRUE" STREQUAL "TRUE")
  set(raspicam_SOURCE_PREFIX /home/fish/softroboticfish6/fish/pi/ros/catkin_ws/src/raspicam)
  set(raspicam_DEVEL_PREFIX /home/fish/softroboticfish6/fish/pi/ros/catkin_ws/devel)
  set(raspicam_INSTALL_PREFIX "")
  set(raspicam_PREFIX ${raspicam_DEVEL_PREFIX})
else()
  set(raspicam_SOURCE_PREFIX "")
  set(raspicam_DEVEL_PREFIX "")
  set(raspicam_INSTALL_PREFIX /home/fish/softroboticfish6/fish/pi/ros/catkin_ws/install)
...
if(NOT "/home/fish/softroboticfish6/fish/pi/ros/catkin_ws/src/raspicam/include " STREQUAL " ")
  set(raspicam_INCLUDE_DIRS "")
  set(_include_dirs "/home/fish/softroboticfish6/fish/pi/ros/catkin_ws/src/raspicam/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'raspicam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fish/softroboticfish6/fish/pi/ros/catkin_ws/src/raspicam/${idir}'.  Ask the maintainer 'pi <pi@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${raspicam_dep}_FOUND)
      find_package(${raspicam_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${raspicam_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
