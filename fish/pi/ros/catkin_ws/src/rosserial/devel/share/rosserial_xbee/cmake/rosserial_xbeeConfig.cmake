...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_xbee_SOURCE_PREFIX /home/fish/rosserial/src/rosserial_xbee)
  set(rosserial_xbee_DEVEL_PREFIX /home/fish/rosserial/devel)
  ...
  set(rosserial_xbee_INSTALL_PREFIX /home/fish/rosserial/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_xbee' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fish/rosserial/src/rosserial_xbee/${idir}'.  Ask the maintainer 'Paul Bouchier <paul.bouchier@gmail.com>' to fix it.")
    endif()
